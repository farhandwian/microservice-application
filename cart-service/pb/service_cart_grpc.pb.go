...
const (
	CartService_CreateCart_FullMethodName = "/pb.CartService/CreateCart"
...
type CartServiceClient interface {
	CreateCart(ctx context.Context, in *AddCartRequest, opts ...grpc.CallOption) (*AddCartResponse, error)
...
func (c *cartServiceClient) CreateCart(ctx context.Context, in *AddCartRequest, opts ...grpc.CallOption) (*AddCartResponse, error) {
...
func (UnimplementedCartServiceServer) CreateCart(context.Context, *AddCartRequest) (*AddCartResponse, error) {
...
func _CartService_CreateCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServiceServer).CreateCart(ctx, req.(*AddCartRequest))
	}
